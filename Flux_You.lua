...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	LeftFrame.Size = UDim2.new(0, 208, 0, 484)
	...
	MainFrame:TweenSize(UDim2.new(0, 700, 0, 455), Enum.EasingDirection.Out, Enum.EasingStyle.Quart,0, true)
		...
		function(io, p)
			if io.KeyCode == CloseBind then
				if uitoggled == false then
					MainFrame:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart,0, true)
					uitoggled = true
	...
	function Tabs:Tab(text,ico)
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			Value.Name = "Value"
			Value.Parent = Title
			Value.BackgroundColor3 = Color3.fromRGB(45, 45, 50)
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			DropItemHolder.BackgroundColor3 = Color3.fromRGB(45, 45, 50)
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(45, 45, 50)
		...
		function ContainerContent:Textbox(text,desc,disapper,callback)
			...
			Description.Name = "Description"
			Description.Parent = Title
			Description.BackgroundColor3 = Color3.fromRGB(45, 45, 50)
			Description.BackgroundTransparency = 1.000
			...
			TextboxFrame.BackgroundColor3 = Color3.fromRGB(60, 60, 65)
		...
		function ContainerContent:Bind(text,presetbind,callback)
			...
			Bind.BackgroundColor3 = Color3.fromRGB(45, 45, 50)
